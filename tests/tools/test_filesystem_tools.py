...
from legalbot.agent.tools.filesystem import (
    EditFileTool,
    ListDirTool,
    ReadFileTool,
    _find_match,
...
class TestWorkspaceRestriction:
    ...
    async def test_read_allowed_in_media_dir(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("legalbot.agent.tools.filesystem.get_media_dir", lambda: media_dir)
    ...
    async def test_extra_dirs_does_not_widen_write(self, tmp_path):
        from legalbot.agent.tools.filesystem import WriteFileTool
