...
table, allowing legalbot to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from legalbot.channels import feishu
...
from legalbot.channels.feishu import FeishuChannel
