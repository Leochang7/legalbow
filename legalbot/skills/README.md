...
This directory contains built-in skills that extend legalbot's capabilities.
...
When skills reference large local documentation or logs, prefer legalbot's built-in
