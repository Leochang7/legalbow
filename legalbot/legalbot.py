"""High-level programmatic interface to legalbot."""
...
class legalbot:
    """Programmatic facade for running the legalbot agent.
    ...
    def from_config(
        ...
        *,
        ...
        """Create a legalbot instance from a config file.

        Args:
            config_path: Path to ``config.json``.  Defaults to
                ``~/.legalbot/config.json``.
            workspace: Override the workspace directory from config.
        """
        from legalbot.config.loader import load_config, resolve_config_env_vars
